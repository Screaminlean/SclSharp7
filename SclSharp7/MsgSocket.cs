...
namespace SclSharp7
{
	...
	class MsgSocket
	{
		...
		{
			get { lock (_staticLock) { return _lastError; } }
			set { lock (_staticLock) { _lastError = value; } }
		}
		...
		public int ReadTimeout
		{
			get
			{
				lock (_syncRoot) { return _ReadTimeout; }
			}
			set
			{
				lock (_syncRoot) { _ReadTimeout = value; }
			}
		}
		...
		public int WriteTimeout
		{
			get
			{
				lock (_syncRoot) { return _WriteTimeout; }
			}
			set
			{
				lock (_syncRoot) { _WriteTimeout = value; }
			}
		}
		public int ConnectTimeout
		{
			get
			{
				lock (_syncRoot) { return _ConnectTimeout; }
			}
			set
			{
				lock (_syncRoot) { _ConnectTimeout = value; }
			}
		}
	}
#endif
